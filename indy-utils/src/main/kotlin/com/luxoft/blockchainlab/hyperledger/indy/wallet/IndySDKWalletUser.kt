...
/**
 * This is an implementation of [IndyWalletUser] which uses indy sdk standard [org.hyperledger.indy.sdk.wallet.Wallet]
...
class IndySDKWalletUser(
    ...
    var did: String
    var verkey: String
    val logger = LoggerFactory.getLogger(IndySDKWalletUser::class.java)
